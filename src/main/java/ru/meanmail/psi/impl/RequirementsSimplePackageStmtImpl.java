...
public class RequirementsSimplePackageStmtImpl extends ASTWrapperPsiElement implements RequirementsSimplePackageStmt {

  public RequirementsSimplePackageStmtImpl(ASTNode node) {
    super(node);
  }
