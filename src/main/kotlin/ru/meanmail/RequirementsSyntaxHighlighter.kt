...
class RequirementsSyntaxHighlighter : SyntaxHighlighterBase() {
    ...
    companion object {
        private val BAD_CHARACTER =
            createTextAttributesKey("REQUIREMENTS_BAD_CHARACTER", HighlighterColors.BAD_CHARACTER)
        private val COMMENT =
            createTextAttributesKey("REQUIREMENTS_COMMENT", DefaultLanguageHighlighterColors.LINE_COMMENT)
        ...
        private val PYTHON_STR_C =
            createTextAttributesKey("REQUIREMENTS_PYTHON_STR_C", DefaultLanguageHighlighterColors.STRING)
        private val VERSION = createTextAttributesKey("REQUIREMENTS_VERSION", DefaultLanguageHighlighterColors.STRING)
        private val OPERATOR =
            createTextAttributesKey("REQUIREMENTS_OPERATOR", DefaultLanguageHighlighterColors.KEYWORD)
        ...
        private val SEMICOLON =
            createTextAttributesKey("REQUIREMENTS_SEMICOLON", DefaultLanguageHighlighterColors.SEMICOLON)
