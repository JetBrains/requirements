...
class RequirementsSyntaxHighlighter : SyntaxHighlighterBase() {
    ...
    override fun getTokenHighlights(tokenType: IElementType): Array<TextAttributesKey> {
        return when (tokenType) {
            ...
            Types.PRE -> IDENTIFIER_KEYS
            Types.PREFER_BINARY -> IDENTIFIER_KEYS
            ...
            Types.USE_FEATURE -> IDENTIFIER_KEYS
    ...
    companion object {
        ...
        private val ENV_VAR = createTextAttributesKey(
        ...
        private val PYTHON_STR_C = createTextAttributesKey(
            "REQUIREMENTS_PYTHON_STR_C",
            DefaultLanguageHighlighterColors.STRING
        )
        private val VERSION = createTextAttributesKey(
            "REQUIREMENTS_VERSION",
            DefaultLanguageHighlighterColors.STRING
        )
        private val OPERATOR = createTextAttributesKey(
            "REQUIREMENTS_OPERATOR",
            DefaultLanguageHighlighterColors.KEYWORD
        )
        private val SHARP = createTextAttributesKey(
            "REQUIREMENTS_SHARP",
            DefaultLanguageHighlighterColors.SEMICOLON
        )
        private val SEMICOLON = createTextAttributesKey(
