...
interface Types {
    object Factory {
        fun createElement(node: ASTNode): PsiElement {
            when (val type = node.elementType) {
                ...
                HASH_OPTION -> return HashOptionImpl(node)
    ...
    companion object {
        ...
        val HASH_OPTION: IElementType = RequirementsElementType("HASH_OPTION")
        ...
        val EQUAL: IElementType = RequirementsTokenType("EQUAL")
        ...
        val HASH: IElementType = RequirementsTokenType("HASH")
        var HEX: IElementType = RequirementsTokenType("HEX")
